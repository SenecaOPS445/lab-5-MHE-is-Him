...
def read_file_list(file_name):
    """
    Takes file_name as a string and returns its entire contents as a list of lines
...
def write_file_list(file_name, list_of_lines):
    """
    Takes a string and a list, writes all items from the list to file,
...
def copy_file_add_line_numbers(file_name_read, file_name_write):
    ...
    writes data to the new file, adding line numbers.
    """
